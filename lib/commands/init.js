...
function saveJson(project, logger, json) {
  ...
  return Q.nfcall(logger.prompt.bind(logger), {
    ...
    return project.saveJson(true).then(function () {
      return good;
    })
  });
}

// Test if value is of a type supported by library.json[0] - Object, Array, String, Boolean - or a Number
// [0]: https://github.com/bower/library.json-spec
